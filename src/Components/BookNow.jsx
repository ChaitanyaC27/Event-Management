...
const BookNow = () => {
  ...
  useEffect(() => {
    if (!user) {
      Swal.fire({
        ...
        html: "You must be <strong>logged in</strong> to submit Booking.",
        icon: "warning",
  ...
  const handleChange = (e) => {
    ...
    setFormData(updated);
    e.target.style.backgroundColor = value ? "#fff3cd" : "#fff";
  ...
  const calculateBudget = (data) => {
    ...
    if (
      ...
      base += parseInt(data.peopleCount || 0) * 300;
    }
    ...
    if (
      ...
      (selectedServices.includes("decoration") ||
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.date || !formData.time || !formData.location.trim()) {
      Swal.fire({
        ...
        text: "Please select Date, Time, and Location before submitting.",
        icon: "warning",
      });
      setLoading(false);
      return;
    ...
    if (
      (!formData.decoration || formData.decoration === "No") &&
      (!formData.catering || formData.catering === "No")
    ) {
      Swal.fire({
  title: "⚠️ Cannot Submit",
  html: `Please select at least <strong>2 Services</strong> and one of them must be <strong>Decoration</strong> or <strong>Catering</strong> for submitting.`,
  icon: "warning",
});
    ...
    try {
      ...
      Swal.fire({
        ...
        html: `<p>Estimated Budget: <strong>${budgetRange}</strong></p>`,
        icon: "success",
        timer: 4000,
      });
    ...
    >
      <div className="container">
        <motion.div
          ...
          animate={{ opacity: 1 }}
        >
          <h2 className="fw-bold text-warning display-6">Book Your Event</h2>
          <p className="text-dark">
            Let us make your day special! Fill details below to get your instant budget.
          </p>
        </motion.div>
              ...
              <div className="card-body p-4">
                <form onSubmit={handleSubmit}>
                  <div className="row g-3">
                    {/* Basic Info */}
                    {["fullName", "email", "contactNumber"].map((field, i) => (
                      <div key={i} className="col-md-6">
                        ...
                        <input
                          ...
                          required
                          style={{
                            backgroundColor: formData[field] ? "#fff3cd" : "#fff",
                          }}
                        />
                      </div>
                    ))}
                    ...
                    <div className="col-md-6">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        style={{
                          backgroundColor: formData.eventType ? "#fff3cd" : "#fff",
                        }}
                      >
                          ...
                          <div className="row g-3 mt-2">
                            ...
                            <div className="col-md-6">
                              ...
                              <select
                                ...
                                onChange={handleChange}
                                style={{
                                  backgroundColor: formData.decoration ? "#fff3cd" : "#fff",
                                }}
                              >
                                <option value="">Select</option>
                            ...
                            <div className="col-md-6">
                              ...
                              <select
                                ...
                                onChange={handleChange}
                                style={{
                                  backgroundColor: formData.catering ? "#fff3cd" : "#fff",
                                }}
                              >
                                <option value="">Select</option>
                                ...
                                >
                                  <div className="col-md-6">
                                    ...
                                    <select
                                      ...
                                      onChange={handleChange}
                                      style={{
                                        backgroundColor: formData.thaliType
                                          ? "#fff3cd"
                                          : "#fff",
                                      }}
                                    >
                                      <option value="">Select</option>
                                      {thaliOptions.map((opt) => (
                                        <option key={opt}>{opt}</option>
                                      ))}
                                    </select>
                                  </div>
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      onChange={handleChange}
                                      style={{
                                        backgroundColor: formData.peopleCount
                                          ? "#fff3cd"
                                          : "#fff",
                                      }}
                                    />
                            ...
                            <div className="col-md-6">
                              ...
                              <select
                                ...
                                onChange={handleChange}
                                style={{
                                  backgroundColor: formData.music ? "#fff3cd" : "#fff",
                                }}
                              >
                                <option value="">Select</option>
                            ...
                            <div className="col-md-6">
                              ...
                              <select
                                ...
                                onChange={handleChange}
                                style={{
                                  backgroundColor: formData.photographer
                                    ? "#fff3cd"
                                    : "#fff",
                                }}
                              >
                            ...
                            <div className="col-md-6">
                              ...
                              <input
                                ...
                                required
                                style={{
                                  backgroundColor: formData.date ? "#fff3cd" : "#fff",
                                }}
                              />
                            </div>
                            <div className="col-md-6">
                              ...
                              <input
                                ...
                                required
                                style={{
                                  backgroundColor: formData.time ? "#fff3cd" : "#fff",
                                }}
                              />
                            </div>
                            <div className="col-12">
                              ...
                              <input
                                ...
                                required
                                style={{
                                  backgroundColor: formData.location ? "#fff3cd" : "#fff",
                                }}
                              />
                            </div>
                            ...
                            <div className="col-12">
                              ...
                              <textarea
                                ...
                                onChange={handleChange}
                                style={{
                                  backgroundColor: formData.specialRequest
                                    ? "#fff3cd"
                                    : "#fff",
                                }}
                              ></textarea>
